 ...
 * An empty clause (clause with no literals) represents false.
 */
public class Clause implements Iterable<Literal> {
    ...
    public Clause add(Literal l) {
        ...
        return new Clause(literals.addToFront(l));
    }
