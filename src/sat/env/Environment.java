...
public class Environment {
    ...
    public Environment() {
        this (new AssocList<Variable, Bool> ());
    }

    /**
     * @return a new environment in which v has the value b
     * if a binding for v already exists, overwrites it
     */
    ...
    /**
     * @return a new environment in which v has the value Bool.TRUE
     * if a binding for v already exists, overwrites it
     */
    ...
    /**
     * @return a new environment in which v has the value Bool.FALSE
     * if a binding for v already exists, overwrites it
     */
