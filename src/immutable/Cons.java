...
public class Cons<E> implements ImList<E> {
    ...
    void checkRep () {
        assert element != null: "Cons: Rep invariant, element non null";
        assert rest != null: "Cons: Rep invariant, rest non null";
        assert size == rest.size() + 1: "Cons: Rep invariant, size";        
    }

    private Cons (E e, ImList<E> r) {
        element = e;
        rest = r;
        size = r.size() + 1;
    }
    ...
    public ImList<E> addToFront(E e) {
        assert e != null: "Cons.add(null)";
    ...
    public ImList<E> remove(E e) {
        assert e != null: "Cons.remove(null)";
        if (element.equals(e)) {
            return rest;
        }
        else {
            ...
            else return new Cons<E> (element, l);
        }
    }
    ...
    public boolean contains (E e) {
        assert e != null: "Cons.contains(null)";
